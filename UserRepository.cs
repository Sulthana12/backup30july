...
namespace MileDALibrary.DataRepository
{
    public class UserRepository : BaseRepository, IUserRepository
    {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                UserResponse = (from DataRow dr in dt.Rows
                                select new DriverDetails()
                                {
                                    ...
                                    Min_recharge_amt = (decimal?)dr["Min_recharge_amt"],
                                }).ToList();
            }
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                UserResponse = (from DataRow dr in dt.Rows
                                select new ConfigSettings()
                                {
                                    ...
                                    ride_type = dr["ride_type"].ToString(),
                                }).ToList();
            }
        ...
        public List<FareCalculations> GetFareCalculations(int userid, string frmloc, string toloc,
            string frmlat, string frmlong, string tolat, string tolong, string kms, string traveltime, string peak_flg)
        {
            ...
            dbparamsFareInfo.Add(new SqlParameter { ParameterName = "@peak_flg", Value = peak_flg, SqlDbType = SqlDbType.VarChar, Direction = ParameterDirection.Input });
        ...
        public List<TrackId> GetFareStatus(int user_track_id, int User_Id)
        {
            List<TrackId> Fare_Status = new List<TrackId>();
            DataTable dt = new DataTable();
            List<DbParameter> dbparamsUserInfo = new List<DbParameter>();
            dbparamsUserInfo.Add(new SqlParameter { ParameterName = "@query_name", Value = "Getfarestatus", SqlDbType = SqlDbType.VarChar, Direction = ParameterDirection.Input });
            dbparamsUserInfo.Add(new SqlParameter { ParameterName = "@user_track_id", Value = user_track_id, SqlDbType = SqlDbType.Int, Direction = ParameterDirection.Input });
            dbparamsUserInfo.Add(new SqlParameter { ParameterName = "@user_id", Value = User_Id, SqlDbType = SqlDbType.Int, Direction = ParameterDirection.Input });
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                Fare_Status = (from DataRow dr in dt.Rows
                               select new TrackId()
                               {
                                   Fare_Status = dr["Fare_Status"].ToString(),
                               }).ToList();
        ...
        public List<ReferralDetails> GetDriversNearBy2Kms(int user_track_id, int otp, string Latitude, string Longitude, string To_Latitude, string To_Longitude, decimal Fare, decimal Fare_Requested_In_Kms, decimal Offered_fare, string Location_Name, int user_id, string status_flg, int Vehicle_id, string fare_type, string others_num, string from_location, string to_location, string user_opted_endtime)
        {
            ...
            dbparamsUserInfo.Add(new SqlParameter { ParameterName = "@offered_fare", Value = Offered_fare, SqlDbType = SqlDbType.Decimal, Direction = ParameterDirection.Input });
            dbparamsUserInfo.Add(new SqlParameter { ParameterName = "@user_id", Value = user_id, SqlDbType = SqlDbType.Int, Direction = ParameterDirection.Input });
            ...
            dbparamsUserInfo.Add(new SqlParameter { ParameterName = "@user_opted_endtime", Value = user_opted_endtime, SqlDbType = SqlDbType.VarChar, Direction = ParameterDirection.Input });
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                cityRangeDetails = (from DataRow dr in dt.Rows
                                    select new CityRangeDetails()
                                    {
                                        ...
                                        start_radius = dr["start_radius"].ToString(),
        ...
        public List<BookingDetails> GetOverallUserRides(int user_id, string status_flg, int user_track_id, string app_type)
        {
            ...
            dbparams.Add(new SqlParameter { ParameterName = "@app_type", Value = app_type, SqlDbType = SqlDbType.VarChar, Direction = ParameterDirection.Input });
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                overallUserRides = (from DataRow dr in dt.Rows
                                    select new BookingDetails()
                                    {
                                        ...
                                        afar_commission = (decimal?)dr["afar_commission"],
                                        gst = (decimal?)dr["gst"],
                                        Total_Fare = (decimal?)dr["Total_Fare"],
                                        duration = Convert.ToInt32(dr["duration"]),
                                        extra_fare = (decimal?)dr["waiting_fee"],
                                        coupon = (decimal?)dr["coupon"],
        ...
        public List<ResponseStatus> SaveDriverRequest(BookingDetails bookingDetails)
        {
            ...
            try
            {
                if (bookingDetails != null)
                {
                    ...
                    dbparams.Add(new SqlParameter { ParameterName = "@to_longitude", Value = bookingDetails.To_longitude, SqlDbType = SqlDbType.VarChar, Direction = ParameterDirection.Input });
                    dbparams.Add(new SqlParameter { ParameterName = "@kms", Value = bookingDetails.Kms, SqlDbType = SqlDbType.Decimal, Direction = ParameterDirection.Input });
                    dbparams.Add(new SqlParameter { ParameterName = "@vehicle_id", Value = bookingDetails.Vehicle_id, SqlDbType = SqlDbType.Int, Size = 1000, Direction = ParameterDirection.Input });
                    dbparams.Add(new SqlParameter { ParameterName = "@response_status", SqlDbType = SqlDbType.VarChar, Size = 100, Direction = ParameterDirection.Output });
        ...
        public List<CalFareAmt> GetFinalFareAmt(int user_track_id)
        {
            List<CalFareAmt> FareResponse = new List<CalFareAmt>();
            DataTable dt = new DataTable();
            List<DbParameter> dbparamsFareInfo = new List<DbParameter>();
            dbparamsFareInfo.Add(new SqlParameter { ParameterName = "@query_name", Value = "GetFareAmt", SqlDbType = SqlDbType.VarChar, Direction = ParameterDirection.Input });
            dbparamsFareInfo.Add(new SqlParameter { ParameterName = "@user_track_id", Value = user_track_id, SqlDbType = SqlDbType.Int, Direction = ParameterDirection.Input });

            dt = SQL_Helper.ExecuteSelect<SqlConnection>("usp_mileapp_usr_book_get", dbparamsFareInfo, SQL_Helper.ExecutionType.Procedure);

            if (dt != null && dt.Rows.Count > 0)
            {
                FareResponse = (from DataRow dr in dt.Rows
                                select new CalFareAmt()
                                {
                                    user_track_id = Convert.ToInt32(dr["fetch_id"]),
                                    travelled_cal_fare = (decimal?)dr["travelled_cal_fare"],
                                    travelled_kms = (decimal?)dr["travelled_kms"],
                                }).ToList();
            }
