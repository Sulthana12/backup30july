...
namespace MileDALibrary.DataRepository
{
    ...
    {
        Task<ResponseModel> SendNotification(NotificationPush notificationpush);
    }

    public class NotificationService : INotificationService
    {
        private readonly FCM_settings _fcmNotificationSettings;
        public NotificationService(IOptions<FCM_settings> settings)
        {
            _fcmNotificationSettings = settings.Value;
        }

        public async Task<ResponseModel> SendNotification(NotificationPush notificationpush)
        {
            ResponseModel response = new ResponseModel();
            try
            {
                if (notificationpush.IsAndroiodDevice)
                {
                    ...
                    string deviceToken = notificationpush.DeviceId;
                    ...
                    dataPayload.Title = notificationpush.Title;
                    dataPayload.Body = notificationpush.Body;
